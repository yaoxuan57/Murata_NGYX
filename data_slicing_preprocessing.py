...
# =========================================================
# 2. SLICE DATA - 14 JUN 2024 14:55:00 TO 4 JULY 2024 (ANOMALOUS PERIOD)
# =========================================================
TEST_START = "2024-06-14 14:55:00"
TEST_END   = "2024-07-04"

anomalous_mask = (df['TIMESTAMP'] >= TEST_START) & (df['TIMESTAMP'] <= TEST_END)

# Split data
test_set = df[anomalous_mask].reset_index(drop=True)  # 14 Jun 2024 14:55:00 - 4 Jul 2024 (testing)
train_val_set = df[~anomalous_mask].reset_index(drop=True)  # Rest (training/validation)

print("=" * 60)
print("DATA SPLIT SUMMARY")
print("=" * 60)
print(f"\nTest Set (14 Jun 2024 14:55:00 - 4 Jul 2024 anomalous):")
...
ax.set_title("Original Data with 14 Jun 2024 14:55:00 - 4 Jul 2024 Test Set Highlighted")
ax.legend()
...
ax.set_xlabel("TIMESTAMP")
ax.set_ylabel("Acceleration RMS")
ax.set_title("Training/Validation Data (Outside 14 Jun 2024 14:55:00 - 4 Jul 2024)")
ax.legend()
ax.grid(True, alpha=0.3)
ax.xaxis.set_major_locator(locator)
ax.xaxis.set_major_formatter(formatter)
...
ax.set_xlabel("TIMESTAMP")
ax.set_ylabel("Acceleration RMS")
ax.set_title("Test Data - 14 Jun 2024 14:55:00 to 4 Jul 2024 (Anomalous Period)")
ax.legend()
ax.grid(True, alpha=0.3)
ax.xaxis.set_major_locator(locator)
ax.xaxis.set_major_formatter(formatter)
