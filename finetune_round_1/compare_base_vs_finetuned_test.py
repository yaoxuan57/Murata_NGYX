...
def process_sensor(
    ...
    *,
    ...
    base_pth = resolve_highest_version_pth(BASE_MODEL_DIR, stem)
    if base_pth is None:
    ...
    if finetuned:
        ...
        print(f"  RMSE base={base['rmse']:.4f} (finetuned checkpoint not found)")
    return summary
...
def main() -> None:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=FINETUNE_DIR / "comparison_test_base_vs_finetuned",
    )
