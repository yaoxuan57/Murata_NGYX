"""Split July.csv (or other multi-sensor export) into per-sensor CSVs under july_by_sensor/."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=FINETUNE_DIR / "July.csv",
        help="Multi-sensor export (default: finetune_round_3_july/July.csv).",
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=FINETUNE_DIR / "july_by_sensor",
        help="Output folder (default: finetune_round_3_july/july_by_sensor).",
    )
    parser.add_argument(
        "--june-only",
        action="store_true",
